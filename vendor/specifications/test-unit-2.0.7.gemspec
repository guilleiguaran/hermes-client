...
Test::Unit (Test::Unit 2.x) will be improved actively.}
  ...
  s.test_files = ["test/test_failure.rb", "test/collector/test_objectspace.rb", "test/collector/test_dir.rb", "test/test_testsuite.rb", "test/test_assertions.rb", "test/util/test_observable.rb", "test/util/test_procwrapper.rb", "test/util/test_backtracefilter.rb", "test/ui/test_testrunmediator.rb", "test/test_testresult.rb", "test/test_error.rb"]
